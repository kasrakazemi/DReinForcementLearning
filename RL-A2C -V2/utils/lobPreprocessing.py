...
class lobPreprocessing:
    ...
    def __init__(self, pathForLOB, lobSwitch = True, mobSwitch = False):
        ...
        if lobSwitch:
            ...
            # self. col_names = ["DateTime","open","high","low","close","Volume","NumTrades","BidVolume",
            # "AskVolume","SumBid","SumAsk","BidPrices","BidVolumes","AskPrices","AskVolumes"]
    ...
    def zscore_nomalization(self, data, freq="1D", min_periods=1):
