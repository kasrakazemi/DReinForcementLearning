...
class rewardCalculation:
    ...
    def reward(self):
        ...
        if self. stepSwith == True:
            if self. selectedAction == "Sell" and self. data["close"][self. step] > self. data["close"][self. step + 1 ]:
                return(+1)
            
            if self. selectedAction == "Buy" and self. data["close"][self. step] < self. data["close"][self. step + 1 ]:
                return(+1)
